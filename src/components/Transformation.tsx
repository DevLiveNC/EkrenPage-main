const transformations = [
  {
    ...
    gained: "+6 kg kas",
    package: "PRO",
    quote: "Özgüvenimi en çok arttıran şey kas kütlemdi. Artık sınırlarımı zorlayabilirim. Aynaya baktığımda kendimi çok sevmeye başladım. Ali sayesinde sınırlarımı zorlamayı öğrendim.",
    emoji: "💪",
  },
  // {
  //   name: "Selin K.",
