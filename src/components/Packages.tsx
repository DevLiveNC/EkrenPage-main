...
const packages = [
  {
    ...
    features: [
      ...
      { text: "Kişiye özel beslenme planı", included: true },
      { text: "7/24 whatsapp desteği", included: true },
      { text: "Haftalık check-in", included: true },
      { text: "Gelişim takibi ve ayarlamalar", included: false },
      { text: "Detaylı analiz ve raporlama", included: false },
      { text: "Öncelikli destek", included: false },
      { text: "Vücut kompozisyon analizi", included: false },
      { text: "Psikolojik motivasyon desteği", included: false },
      { text: "Uzun vadeli strateji", included: false },
    ],
  },
  {
    id: "pro",
    ...
    features: [
      ...
      { text: "7/24 whatsapp desteği", included: true },
      { text: "Haftalık check-in", included: true },
      { text: "Gelişim takibi ve ayarlamalar", included: true },
      { text: "Detaylı analiz ve raporlama", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Detaylı analiz ve raporlama", included: true },
      { text: "Öncelikli destek", included: true },
      { text: "Vücut kompozisyon analizi", included: true },
      { text: "Psikolojik motivasyon desteği", included: true },
      { text: "Uzun vadeli strateji", included: true },
    ],
  },
];
